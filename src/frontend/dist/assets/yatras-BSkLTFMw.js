            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    position: "absolute",
                    inset: 0,
                    background: "linear-gradient(to top, rgba(20,12,0,0.6) 0%, transparent 50%)"
                  }
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { position: "absolute", bottom: "12px", left: "12px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  style: {
                    background: "#C8960C",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { fontFamily: "var(--font-body)", fontSize: "12px" }, children: [
                      "From",
                      " "
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "span",
                  {
                    ...
                    children: [
                      ...
                      yatra.templeAltitudeM.toLocaleString(),
                      "m"
                    ]
                  }
                ),
...
const yatras = [
  {
    ...
    reviewCount: 847,
    isFeatured: true,
    description: "Kedarnath is the holiest of the 12 Jyotirlingas and one of the four Char Dhams. Situated at 3,583m in the Rudraprayag district, the ancient temple has stood for over 1,200 years. Lord Shiva is believed to have appeared as a bull at this sacred spot to escape the Pandavas after the Kurukshetra war. The temple, restored by Adi Shankaracharya in the 8th century, is surrounded by the majestic Kedarnath range, Kedar Dome, and the Mandakini River.",
    significance: [
    ...
    itinerary: [
      {
        ...
        altitude: "1,319m",
        description: "Drive 180km from Haridwar/Rishikesh through the scenic Kedar Valley. Pass through Devprayag, Rudraprayag, and reach Guptkashi. Evening visit to Vishwanath Temple. Overnight hotel."
      },
      {
        day: 2,
        title: "Guptkashi to Gaurikund to Kedarnath Trek",
        altitude: "3,583m",
        description: "Drive to Sonprayag (30km), then shuttle to Gaurikund (5km). Begin the 16km trek or take pony/doli to Kedarnath. Arrive by evening. Attend the mesmerizing Sandhya Aarti. Overnight at altitude (3,583m)."
      },
      {
        day: 3,
        title: "Kedarnath Darshan - Return to Guptkashi",
        altitude: "3,583m to 1,319m",
        description: "Wake at 3:30 AM for the divine Mangal Aarti (4 AM). Garbha Griha darshan. Special puja options: Rudrabhishek (book in advance). After darshan, begin descent to Gaurikund and drive to Guptkashi."
      },
      {
        day: 4,
        title: "Guptkashi to Haridwar",
        description: "Morning drive back to Haridwar/Rishikesh (180km, 6hrs). Tour ends."
      }
    ],
    transportOptions: [
    ...
    registration: "Online biometric registration mandatory via devasthanam.uk.gov.in"
  },
  {
    slug: "do-dham",
    name: "Do Dham Yatra",
    ...
    reviewCount: 534,
    isFeatured: true,
    description: "The Do Dham Yatra combines the two most powerful pilgrimage sites of Uttarakhand - Kedarnath (Lord Shiva at 3,583m) and Badrinath (Lord Vishnu at 3,133m). This sacred journey through the Garhwal Himalayas is one of the most fulfilling spiritual experiences available to devotees.",
    significance: [
    ...
    itinerary: [
      ...
      },
      {
        ...
        altitude: "3,583m",
        description: "Drive to Gaurikund, then 16km trek or pony/helicopter to Kedarnath. Sandhya Aarti. Overnight at Kedarnath."
      },
      {
        day: 3,
        title: "Kedarnath Darshan to Rudraprayag",
        altitude: "3,583m",
        description: "Mangal Aarti (4 AM) + Garbha Griha darshan. Descend to Gaurikund. Drive to Rudraprayag/Chamoli."
      },
      {
        day: 4,
        title: "Drive to Badrinath",
        altitude: "3,133m",
        description: "Drive 130km from Guptkashi through Joshimath. Arrive Badrinath. Evening Aarti. Overnight Badrinath."
      },
      {
        day: 5,
        title: "Badrinath Darshan + Sightseeing",
        description: "Morning Badrinath darshan. Tapt Kund ritual bath. Mana Village. Vasundhara Falls. Drive towards Haridwar."
      },
      {
        day: 6,
        title: "Return to Haridwar",
        description: "Complete journey back to Haridwar. Tour ends with divine blessings of both Dhams."
      }
    ],
    transportOptions: [
    ...
    registration: "Biometric registration required for both Kedarnath and Badrinath"
  },
  {
    slug: "char-dham",
    ...
    reviewCount: 723,
    isFeatured: true,
    description: "The Char Dham Yatra is the most sacred pilgrimage circuit in Hinduism, covering the four holy shrines of Uttarakhand: Yamunotri, Gangotri, Kedarnath, and Badrinath. Completing this circuit is considered equivalent to moksha (liberation).",
    significance: [
    ...
    itinerary: [
      ...
      },
      {
        ...
        altitude: "3,291m",
        description: "Drive to Janki Chatti. Trek 5km to Yamunotri temple. Cook rice in Surya Kund. Darshan. Return to Barkot."
      },
      {
        day: 3,
      ...
      },
      {
        ...
        altitude: "3,048m",
        description: "Drive to Gangotri (100km). Morning darshan. Bhagirathi Shila. Evening Ganga Aarti. Return to Uttarkashi."
      },
      {
        day: 5,
      ...
      },
      {
        ...
        altitude: "3,583m",
        description: "Gaurikund to 16km trek to Kedarnath. Sandhya Aarti. Overnight altitude stay."
      },
      {
        day: 7,
        title: "Kedarnath Darshan to Drive toward Badrinath",
        description: "Mangal Aarti (4 AM). Garbha Griha darshan. Descent. Drive to Joshimath/Badrinath."
      },
      {
        day: 8,
        title: "Badrinath Darshan",
        altitude: "3,133m",
        description: "Badrinath temple darshan. Tapt Kund. Evening Aarti. Mana Village. Overnight Badrinath."
      },
      {
        day: 9,
    ...
    registration: "Mandatory biometric + online registration for all 4 dhams via Uttarakhand government portal"
  },
  {
    slug: "panch-kedar",
    ...
    itinerary: [
      ...
      },
      {
        ...
        description: "4 AM Mangal Aarti. Garbha Griha darshan. Descend to Guptkashi."
      },
      {
        day: 4,
        title: "Drive to Chopta to Tungnath",
        altitude: "3,680m",
        description: "Drive to Chopta. Trek 3.5km to Tungnath. Darshan. Return to Chopta."
      },
      {
        day: 5,
        title: "Chopta to Gopeshwar (Rudranath base)",
        description: "Drive to Gopeshwar. Rest before challenging Rudranath trek."
      },
      {
        day: 6,
      ...
      },
      {
        ...
        altitude: "3,497m",
        description: "Trek 24km to Madhyamaheshwar through beautiful meadows. Darshan."
      },
      {
        day: 10,
...
const getYatraBySlug = (slug) => yatras.find((y) => y.slug === slug);
export {
  YatraCard as Y,
  getYatraBySlug as g,
  yatras as y
