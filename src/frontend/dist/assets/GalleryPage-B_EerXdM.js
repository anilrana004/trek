...
function GalleryPage() {
  ...
  reactExports.useEffect(() => {
    const onKey = (e) => {
      ...
      if (e.key === "ArrowRight") {
        setLightbox(
          (l) => l && l.idx < filteredImages.length - 1 ? { idx: l.idx + 1 } : l
        );
      }
      if (e.key === "ArrowLeft") {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h1",
                {
                  ...
                  children: "Global Trek Photo Gallery"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "Moments from the trail — Uttarakhand peaks, Himachal valleys, sacred yatras and Himalayan wildlife."
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: filters.map((filter) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
                      role: "tab",
                      ...
                      style: {
                        padding: "8px 20px",
                        borderRadius: "9999px",
                        border: activeFilter === filter ? "2px solid #ffffff" : "2px solid rgba(255,255,255,0.25)",
                        background: activeFilter === filter ? "#ffffff" : "rgba(255,255,255,0.08)",
                        color: activeFilter === filter ? "var(--green-dark)" : "#ffffff",
                        fontFamily: "var(--font-body)",
                        fontSize: "13px",
                        fontWeight: 600,
                        cursor: "pointer",
          ...
          "section",
          {
            ...
            children: columns.map((col, colIdx) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsx(
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "div",
                            {
                              ...
                              style: {
                                position: "absolute",
                                inset: 0,
                                background: "linear-gradient(to top, rgba(20,92,56,0.88) 0%, rgba(0,0,0,0.2) 60%, transparent 100%)",
                                opacity: 0,
                ...
                ((_b = (_a = col[0]) == null ? void 0 : _a.url) == null ? void 0 : _b.slice(-10)) ?? String(colIdx)
              );
            })
          }
        ),
        filteredImages.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: "No photos in this category"
              }
            )
          }
        ),
        lightbox !== null && currentImage && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "dialog",
          {
            open: true,
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  onClick: () => lightbox.idx > 0 && setLightbox({ idx: lightbox.idx - 1 }),
                  style: {
                    position: "absolute",
                    left: "16px",
                    top: "50%",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  onClick: () => lightbox.idx < filteredImages.length - 1 && setLightbox({ idx: lightbox.idx + 1 }),
                  style: {
                    position: "absolute",
                    right: "16px",
                    top: "50%",
                    ...
                    color: "#fff",
                    fontSize: "20px",
                    cursor: lightbox.idx === filteredImages.length - 1 ? "default" : "pointer",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: "20px", textAlign: "center" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    style: {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: currentImage.location
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "p",
