const treks = [
  {
    ...
    isTrending: true,
    isEditorsPick: true,
    shortDescription: "World's highest Shiva temple + 360 panorama of Nanda Devi, Trishul and Chaukhamba from Chandrashila Summit.",
    highlights: [
    ...
    itinerary: [
      {
        ...
        description: "Drive 7-8 hours from Rishikesh through the stunning Kedarnath valley. Passing through Devprayag, Rudraprayag, and Ukhimath before reaching the magical meadows of Chopta. Acclimatization walk in the bugyals. Campfire dinner under the stars with views of the Himalayan skyline."
      },
      {
        day: 2,
        ...
        distance: "10km",
        description: "Early morning trek to Tungnath Temple (3.5km, 2-3 hrs) through oak and rhododendron forest. Darshan at the highest Shiva shrine. Continue to Chandrashila Summit for breathtaking 360 views. Descend to Chopta, then drive to Sari village for overnight stay."
      },
      {
        day: 3,
        ...
        altitude: "2,438m",
        distance: "6km",
        description: "Morning trek to Deoriatal Lake (3km, 2hrs) - the magical emerald lake reflecting the Chaukhamba massif. Perfect sunrise photography spot. Descend to Sari village and drive back to Rishikesh by evening."
      }
    ],
    inclusions: [
  ...
  },
  {
    ...
    reviewCount: 187,
    isEditorsPick: true,
    shortDescription: "Trek through the mythological Valley of Gods - remote ancient villages, glacier views, and Himalayan wildlife.",
    highlights: [
    ...
    itinerary: [
      {
        ...
        description: "Drive 8 hours from Dehradun through Purola and Mori valleys. Arrive at Sankri, the base village at 1,920m. Village orientation walk, meet your guide team."
      },
      {
        day: 2,
        ...
        altitude: "2,600m",
        distance: "12km",
        description: "Short drive to Taluka (3km), then begin trek through dense forest. Cross the Supin River multiple times. Pass through dramatic gorge landscapes. Reach Seema campsite."
      },
      {
        day: 3,
        ...
        altitude: "2,565m",
        distance: "9km",
        description: "Trek to Osla village, passing through ancient deodar forests. Visit the unique Duryodhana Temple where the Mahabharata villain is worshipped. Explore traditional Garhwali architecture."
      },
      {
        day: 4,
        ...
        altitude: "3,200m",
        distance: "12km",
        description: "Ascend through the widening valley with stunning views of Swargarohini peak group. Wildflowers carpet the trail in spring. Reach base camp at 3,200m."
      },
      {
        day: 5,
        ...
        altitude: "3,566m",
        distance: "8km",
        description: "Full valley exploration day. Trek to Har Ki Dun meadow (3,566m). Optional Maninda Lake day trip. Wildlife spotting opportunity."
      },
      {
        day: 6,
        ...
        altitude: "2,565m",
        distance: "12km",
        description: "Begin descent through the magical valley. Wildflowers and rushing streams accompany the descent."
      },
      {
        day: 7,
        ...
        altitude: "1,920m",
        distance: "21km",
        description: "Long descent day via Seema village. Trek through riverside trails with forested ridge views. Reach Sankri by afternoon."
      },
      {
        day: 8,
        title: "Sankri to Dehradun",
        description: "Drive back to Dehradun (8hrs). Drop at Dehradun railway station or bus stand."
      }
    ],
    inclusions: [
  ...
  },
  {
    ...
    isTrending: true,
    isMostBooked: true,
    shortDescription: "India's most celebrated winter trek - 360 snow summit panorama with frozen lakes and snow-laden deodar forests.",
    highlights: [
    ...
    itinerary: [
      {
        ...
        title: "Dehradun to Sankri",
        distance: "210km drive",
        description: "Drive from Dehradun (8hrs) through Mussoorie and Nainbagh to Sankri village at 2,000m. Orientation walk in the village. Traditional Garhwali dinner. Overnight at Sankri."
      },
      {
        day: 2,
        ...
        altitude: "2,950m",
        distance: "6km",
        description: "Begin the trail through dense forest of oak and rhododendron. Steady climb through snow (in winter) to Juda Ka Talab - the enchanting lake that freezes solid December-February."
      },
      {
        day: 3,
        ...
        altitude: "3,430m",
        distance: "4km",
        description: "Short but rewarding climb through increasingly snow-covered trail. The treeline gradually gives way to open alpine meadows. Reach Kedarkantha Base camp with dramatic summit views."
      },
      {
        day: 4,
        ...
        altitude: "3,810m",
        distance: "10km total",
        description: "Pre-dawn start (4 AM) for the summit. Climb through pristine snow slopes as the sky turns golden. Reach Kedarkantha Summit at sunrise - panorama of Himalayan peaks paints itself gold. Descend to Juda Ka Talab."
      },
      {
        day: 5,
        title: "Juda Ka Talab to Sankri to Dehradun",
        distance: "6km trek + drive",
        description: "Final descent through forest trail to Sankri. Certificate distribution and farewell. Drive to Dehradun."
      }
    ],
    inclusions: [
  ...
  },
  {
    ...
    reviewCount: 203,
    isEditorsPick: true,
    shortDescription: "The legendary Lord Curzon Trail - grandest amphitheater view of Garhwal Himalayas including mighty Nanda Devi (7,816m).",
    highlights: [
    ...
    itinerary: [
      {
        ...
        description: "Drive through the Alaknanda valley, passing Devprayag, Rudraprayag, Karanprayag, and Chamoli. Arrive Joshimath (1,890m). Overnight rest."
      },
      {
        day: 2,
        ...
        altitude: "3,056m",
        distance: "6km",
        description: "Take cable car from Joshimath to Auli (world highest ski resort) or trek 3km. Continue to Gorson Bugyal (3,056m) through dense oak and rhododendron forests. Sweeping meadow views."
      },
      {
        day: 3,
        ...
        altitude: "3,200m",
        distance: "5km",
        description: "Gradual ascent through open meadows and patches of forest. The Nanda Devi summit gradually reveals itself. Camp Tali at 3,200m."
      },
      {
        day: 4,
        ...
        altitude: "3,600m",
        distance: "6km",
        description: "Most dramatic day. Full Garhwal Himalayan panorama unfolds - Nanda Devi (7,816m), Dronagiri, Kamet (7,756m), Chaukhamba, Neelkanth. Camp at Khullara Top (3,600m)."
      },
      {
        day: 5,
        ...
        altitude: "3,820m",
        distance: "8km",
        description: "Final ascent to Kuari Pass (3,820m). Magnificent panorama. Descend steeply to Tapovan village (2,600m) through bamboo forest."
      },
      {
        day: 6,
        title: "Tapovan to Joshimath to Haridwar",
        description: "Drive from Tapovan to Joshimath (12km). Breakfast, then drive back to Haridwar (280km)."
      }
    ],
    inclusions: [
  ...
  },
  {
    ...
    rating: 4.8,
    reviewCount: 156,
    shortDescription: "India's longest continuous ridge walk - 4+ hours on top of the world with 360 Himalayan panorama. Offbeat and uncrowded.",
    highlights: [
    ...
    itinerary: [
      {
        ...
        title: "Dehradun to Sankri",
        distance: "210km drive",
        description: "Drive from Dehradun to Sankri village (1,950m) through beautiful Uttarkashi district. Orientation walk. Overnight at Sankri."
      },
      {
        day: 2,
        title: "Sankri to Juda Ka Talab",
        altitude: "2,730m",
        distance: "6km",
        description: "Trek through forest to Juda Ka Talab. Beautiful camp beside the tranquil lake with Himalayan backdrop."
      },
      {
        day: 3,
        ...
        altitude: "3,400m",
        distance: "8.4km",
        description: "Ascend gradually above treeline. The ridge comes into view. Camp at Bhoj Gadi (3,400m) with first ridge views."
      },
      {
        day: 4,
        ...
        altitude: "3,700m",
        distance: "8.4km",
        description: "HIGHLIGHT DAY. Ascend to the Phulara Ridge (3,700m) and walk along it for 4+ hours. 360 panoramic views in every direction. Descend to Pushtara Meadow (2,800m)."
      },
      {
        day: 5,
        title: "Pushtara to Sankri to Dehradun",
        distance: "8km trek + drive",
        description: "Morning descent through Taluka village back to Sankri. Drive to Dehradun."
      }
    ],
    inclusions: [
      "Trekking guide",
  ...
  },
  {
    ...
    isTrending: true,
    isMostBooked: true,
    shortDescription: "UNESCO World Heritage Site - 500+ species of wildflowers bloom in this magical valley July-September, combined with Hemkund Sahib pilgrimage.",
    highlights: [
    ...
    itinerary: [
      ...
      },
      {
        ...
        altitude: "3,049m",
        distance: "14km",
        description: "Trek through Bhyundar valley alongside roaring Pushpawati River. Dense forests gradually open to Ghangaria base camp."
      },
      {
        day: 3,
        ...
        altitude: "3,658m",
        distance: "12km",
        description: "Full day in the Valley of Flowers. Carpet of wildflowers in every color. Photography, exploration, and botanical discovery."
      },
      {
        day: 4,
        title: "Hemkund Sahib",
        altitude: "4,329m",
        distance: "12km",
        description: "Steep climb to Hemkund Sahib (4,329m) - the sacred glacial lake and Gurudwara. Spiritual experience at highest Sikh shrine."
      },
      {
        day: 5,
  ...
  },
  {
    ...
    reviewCount: 267,
    isTrending: true,
    shortDescription: "The mysterious Skeleton Lake at 5,029m - 500+ skeletal remains dating to the 9th century with breathtaking views of Trishul (7,120m).",
    highlights: [
    ...
    itinerary: [
      ...
      },
      {
        ...
        altitude: "3,750m",
        distance: "9km",
        description: "Ascend to Ali Bugyal - one of India's most beautiful meadows."
      },
      {
        day: 4,
      ...
      },
      {
        ...
        altitude: "5,029m",
        distance: "8km",
        description: "Pre-dawn summit push to Roopkund Lake. View the skeletal remains. Panorama of Trishul and Nanda Ghunti."
      },
      {
        day: 7,
  ...
  },
  {
    ...
    rating: 4.7,
    reviewCount: 198,
    shortDescription: "Perfect winter trek with a frozen lake reflecting Mt. Trishul and Nanda Ghunti - less crowded than Kedarkantha.",
    highlights: [
  ...
  },
  {
    ...
    rating: 4.7,
    reviewCount: 167,
    shortDescription: "One of India's most beautiful high-altitude meadows - skiing in winter, wildflower carpets in summer.",
    highlights: [
  ...
  },
  {
    ...
    reviewCount: 389,
    isMostBooked: true,
    shortDescription: "Perfect weekend trek from Dehradun/Mussoorie - summit views of Swargarohini, Bandarpunch and the Kedarnath range.",
    highlights: [
    ...
    itinerary: [
      {
        ...
        altitude: "2,500m",
        distance: "8km",
        description: "Drive to Pantwari (2,000m), trek to the forest campsite. Campfire dinner under stars."
      },
      {
        day: 2,
        ...
        altitude: "3,022m",
        distance: "8km",
        description: "Early morning summit push. Views of the Himalayan range. Descend and drive back to Dehradun."
      }
    ],
    inclusions: [
      "Guide",
  ...
  },
  {
    ...
    isTrending: true,
    isEditorsPick: true,
    shortDescription: "India's most dramatic crossover trek - lush green Kullu Valley to stark desert Lahaul in a single pass crossing.",
    highlights: [
    ...
    itinerary: [
      {
        ...
        altitude: "3,100m",
        distance: "3km trek",
        description: "Drive from Manali to Jobra (20km). Short trek to Chika campsite on the banks of the Rani Nallah river."
      },
      {
        day: 2,
        ...
        altitude: "3,720m",
        distance: "8km",
        description: "Trek along the glacial river with multiple stream crossings. Alpine meadows with wildflowers. Arrive at Balu Ka Ghera."
      },
      {
        day: 3,
        ...
        altitude: "4,270m",
        distance: "14km",
        description: "EPIC DAY. Steep ascent to Hampta Pass (4,270m). Landscape transforms dramatically - green valley behind, stark Lahaul desert ahead. Descend to Shea Goru (3,700m)."
      },
      {
        day: 4,
        ...
        altitude: "4,300m",
        distance: "5km trek",
        description: "Trek to Chatru (3,360m) and drive to Chandratal Lake. Camp beside this crescent-shaped jewel at 4,300m."
      },
      {
        day: 5,
  ...
  },
  {
    ...
    reviewCount: 291,
    isTrending: true,
    shortDescription: "Parvati Valley crown jewel - Sar Lake at 4,270m with thrilling snow slide descent and remote village experiences.",
    highlights: [
    ...
    itinerary: [
      {
        ...
        altitude: "2,380m",
        distance: "8.5km",
        description: "Trek from Kasol through Parvati Valley forest to Grahan village (2,380m). Homestay or camp. Traditional Himachali dinner."
      },
      {
        day: 2,
        ...
        altitude: "2,900m",
        distance: "9km",
        description: "Ascend through alpine meadows and dense forest to Mina Thatch campsite (2,900m)."
      },
      {
        day: 3,
        ...
        altitude: "3,550m",
        distance: "6km",
        description: "Above treeline, snow patches begin. Reach Nagaru camp (3,550m) with panoramic views."
      },
      {
        day: 4,
        ...
        altitude: "4,270m",
        distance: "12km",
        description: "Summit to Sar Pass (4,270m). Views of Sar Lake. Thrilling snow slide descent in April-May. Long descent to Biskeri Thach."
      },
      {
        day: 5,
        title: "Biskeri Thach to Barshaini to Kasol",
        distance: "14km",
        description: "Final descent through forest to Barshaini village. Drive to Kasol."
      }
    ],
  ...
  },
  {
    ...
    reviewCount: 512,
    isMostBooked: true,
    shortDescription: "Parvati Valley beloved trail ending in a magical natural hot spring - the reward after the trek is truly heavenly.",
    highlights: [
    ...
    itinerary: [
      {
        ...
        altitude: "2,950m",
        distance: "7km",
        description: "Drive to Barshaini, trek through forest and meadows to Kheerganga. Dip in the hot spring! Overnight camp."
      },
      {
        day: 2,
  ...
  },
  {
    ...
    reviewCount: 678,
    isMostBooked: true,
    shortDescription: "McLeod Ganj iconic trek - dramatic views of the Dhauladhar range from a stunning ridge campsite.",
    highlights: [
    ...
    itinerary: [
      {
        ...
        altitude: "2,850m",
        distance: "9km",
        description: "Trek from McLeod Ganj through oak and rhododendron forest to Triund ridge. Sunset over the Dhauladhar. Overnight camp."
      },
      {
        day: 2,
        title: "Triund to McLeod Ganj",
        distance: "9km",
        description: "Early morning views of the Dhauladhar at sunrise. Descend to McLeod Ganj."
      }
    ],
  ...
  },
  {
    ...
    rating: 4.7,
    reviewCount: 187,
    shortDescription: "Source of the sacred Beas River - a glacial lake with spectacular views of Hanuman Tibba and Shitidhar peak.",
    highlights: [
    ...
    itinerary: [
      {
        ...
        altitude: "3,200m",
        distance: "7km",
        description: "Drive to Dhundi (2,800m). Trek to Bakarthach meadow campsite."
      },
      {
        day: 2,
        ...
        altitude: "3,700m",
        distance: "6km",
        description: "Trek to Beas Kund glacial lake. Views of Hanuman Tibba. Return to Bakarthach."
      },
      {
        day: 3,
...
const getTrekBySlug = (slug) => treks.find((t) => t.slug === slug);
const getTreksByState = (state) => treks.filter((t) => t.state === state);
export {
  getTreksByState as a,
  getTrekBySlug as g,
  treks as t
};
