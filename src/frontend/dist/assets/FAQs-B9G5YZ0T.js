...
function AccordionItem({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { borderBottom: "1px solid var(--border-subtle)" }, children: [
      ...
      children: [
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "Everything you need to know before your Himalayan adventure."
                }
              )
            ]
          }
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: faqData.map((cat, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "section",
          {
            ...
            children: faqData[activeTab].items.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              AccordionItem,
              {
                item,
              ...
              `${activeTab}-${item.q.slice(0, 20).replace(/\s/g, "-")}`
            ))
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
