const blogPosts = [
  ...
  },
  {
    ...
    isFeatured: true,
    content: "The layering system is not optional in the Himalayas. Base layer: moisture-wicking synthetic or merino wool - NOT cotton. Mid layer: Fleece 200gsm or down vest. Outer layer: Waterproof and windproof hardshell jacket - Gore-Tex or equivalent. Down jacket for camp - 700+ fill power.\n\n## Footwear: The Most Critical Choice\n\nRequirements: High ankle support, waterproof membrane (Gore-Tex preferred), Vibram rubber sole, BREAK THEM IN before the trek - 2 weeks minimum.\n\n## Altitude Essentials\n\nSunscreen SPF50+: UV radiation increases 4% per 300m altitude. Sunglasses UV400. Water purification tablets. Diamox (Acetazolamide) - consult your doctor. First aid kit: bandages, antiseptic, blister plasters, ORS sachets, Ibuprofen."
  },
  {
    slug: "kuari-pass-lord-curzon-trail",
    title: "Kuari Pass (Lord Curzon Trail): The Trek Where History Meets the Himalayas",
    excerpt: "In 1905, British Viceroy Lord Curzon walked this route and wrote that it was the finest view in the world. 120 years later, the Kuari Pass panorama still stops trekkers in their tracks.",
    category: "Trek Stories",
    author: "Priya Sharma",
    authorBio: "Travel Writer and Trekker | Specialist in Himalayan Spirituality",
    date: "2026-03-10",
